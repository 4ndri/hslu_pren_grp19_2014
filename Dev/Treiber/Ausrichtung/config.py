...
class ARConfig:
    def __init__(self):
        ...
        self.dir_pin = self.config.get_number("Ausrichtung", "dir_pin", 27)
        self.pulse_pin =self.config.get_number("Ausrichtung", "pulse_pin", 17)
        self.enable_pin =self.config.get_number("Ausrichtung", "enable_pin", 23)
        self.microsteps_pin =self.config.get_number("Ausrichtung", "microsteps_pin", 22)
    ...
    def save_config(self):
        ...
        self.config.set_number("Ausrichtung", "microsteps_pin", self.microsteps_pin)
